                        ...
                        <div role="tabpanel">
                            ...
                            <div class="tab-content">
                                                    ...
                                                    <form class="form-horizontal" method="POST" role="form" action="">
                                                        ...
                                                        <div
                                                            ...
                                                            <label for="current_password"
                                                                class="col-md-12 col-lg-4 control-label">Contraseña
                                                                actual</label>
                                                        ...
                                                        <div
                                                            ...
                                                            <label for="password"
                                                                class="col-md-12 col-lg-6 control-label">Nueva
                                                                contraseña</label>
                                                        ...
                                                        <div class="form-group">
                                                            <label for="password-confirm"
                                                                class="col-md-12 col-lg-6 control-label">Confirmar
                                                                contraseña</label>
                                ...
                                <div role="tab-panel" class="tab-pane" id="notificaciones">
                                    ...
                                    <div role="alert" aria-live="assertive" aria-atomic="true" class="notificaciones1"
                                        data-autohide="false">
                                        <div class="toast-header">
                                            <strong class="mr-auto">ADMINISTRACIÓN</strong>
                                            <small>Hace 15 minutos</small>
                                            <button type="button" class="ml-2 mb-1 close" data-dismiss="notificaciones1"
                                                aria-label="Close">
